...
#include <Muon/Misc.h>
    ...
    #pragma warning(disable : 4668) // 'X' not defined as a preprocessor macro, replacing with '0' for '#if/#elif'

    // https://stackoverflow.com/questions/39479163 what's the difference between 4018 and 4389
    #pragma warning(disable : 4388) // signed/unsigned mismatch
    #pragma warning(disable : 4018) // expression' : signed/unsigned mismatch
    #pragma warning(disable : 4365) // Conversion from 'int' to 'unsigned long', signed/unsigned mismatch
    #pragma warning(disable : 4774) // format string expected in argument 'x' is not a string literal
    #pragma warning(disable : 4267) // 'var' : conversion from 'x' to 'y', possible loss of data
